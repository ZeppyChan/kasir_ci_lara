...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('pos/css/posajax.css') }}" type="text/css"/>
...
<?php if ($Settings->user_rtl) {?>
    <link href="{{ asset('assets/styles/helpers/bootstrap-rtl.min.css') }}" rel="stylesheet"/>
    <link href="{{ asset('assets/styles/style-rtl.css') }} " rel="stylesheet"/>
